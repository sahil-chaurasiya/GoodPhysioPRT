          ...
          {filtered.map((u) => (
            <div key={u._id} className="card flex items-center justify-between p-4">
              <div className="min-w-0">
                ...
                <p className="text-xs text-slate-400">{u.isInactive ? 'Inactive' : 'true / Active'}</p>
              </div>
              <div className="relative">
                <button onClick={() => setOpenMenuId(openMenuId === u._id ? null : u._id)} className="rounded-full p-1.5 text-slate-400 hover:bg-slate-100">
